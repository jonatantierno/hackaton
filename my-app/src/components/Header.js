    ...
    render() {
        ...
        return (
            <Navbar color="light" light expand="md">
                <NavbarBrand className="tittle-header" href="/">&nbsp;ArpanetOS</NavbarBrand>
                ...
                <Collapse isOpen={this.state.isOpen} navbar>
                    <Nav className="ml-auto" navbar>
                        ...
                        <UncontrolledDropdown nav inNavbar>
                            ...
                            <DropdownMenu right>
                                <DropdownItem>
                                    <NavLink className="nav-item-text" href={etherscanaccount}> User: {this.props.defaultaccount}</NavLink>
                                </DropdownItem>
                                <DropdownItem>
                                    <NavLink className="nav-item-text" href={etherscanaccount}> Reputation: 200 Tokens</NavLink>
                                </DropdownItem>
                                <DropdownItem>
                                    <NavLink className="nav-item-text" href={etherscancontract}> Smart Contract Reputation: {this.props.contractaddress}</NavLink>
                                </DropdownItem>
                                <DropdownItem>
